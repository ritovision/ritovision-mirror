...
const homeHeroItems = [
  { text: 'Rito', color: '#FC1819' },
  { text: 'Vision', color: '#FC1819' },
  {
    text: <>See <span style={{ color: '#FFFFFF' }}>between</span> the seams</>,
    color: '#FC1819',
  },
];

const homeHeroTrailingText = <>And <span style={{ whiteSpace: 'nowrap' }}><span style={{ color: '#FFFFFF' }}>build</span> it</span></>;
      ...
      <div className={styles.heroContainer}>
        <div className={styles.desktopContainer}>
          {animationReady ? (
            <BlockTextSequence
              items={homeHeroItems}
              trailingText={homeHeroTrailingText}
