...
const titles: TitleItem[] = [
  { text: "Product", enter: "slide", exit: "fade" },
  { text: "Brand", enter: "glitch", exit: "particles" },
  { text: "UX", enter: "typewriter", exit: "glitch" },
  { text: "Engineering", enter: "glitch", exit: "typewriter" },
];
